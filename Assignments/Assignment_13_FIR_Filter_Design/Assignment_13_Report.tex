...
\textbf{File:} \texttt{assignment13\_fir.py}
\begin{lstlisting}[caption={FIR Filter Design: Window Method and Frequency Sampling -- Assignment 13}]
import numpy as np
...
def run_assignment13():
    ...
    # Low-pass FIR via Hamming window
    N = 21
    M = 10
    wc = 0.4 * np.pi
    n = np.arange(N)
